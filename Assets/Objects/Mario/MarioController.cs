...
public class MarioController : MonoBehaviour
{
	...
	public void SetAnim(string animName, float transitionTime = 0.1f, float animSpeed = 1)
	{
		if (!isAnim (animName)) {
			if(transitionTime == 0 || anim.IsInTransition(0)) anim.Play(animName);
			else
